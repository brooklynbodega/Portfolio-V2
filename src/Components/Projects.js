    ...
    return (
      <div className="projects-wrapper">
        <div className="projects" id="project-one">
            <a className="image-container" href="https://brooklynbodega.github.io/Project-01/">
        ...
        <div className="projects" id="project-two">
            <a className="image-container" href="https://project-2-volunteer.herokuapp.com/">
        ...
        <div className="projects" id="project-three">
            <a className="image-container" href="https://lovo.netlify.com/">
